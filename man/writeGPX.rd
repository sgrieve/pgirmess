...
\details{
  ...
  \itemize{
  \item{column 1}{character or integer, waypoint ID for waypoints ; column not read for track}
  \item{column 2}{numeric, longitude (decimal degrees), negative for west}
  \item{column 3}{numeric, latitude (decimal degrees), negative for south}
  \item{column 4}{numeric, elevation (meters) (optional)}
